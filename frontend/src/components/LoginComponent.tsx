...
const LoginComponent: React.FC<{ 
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 px-3 sm:px-4 py-4 sm:py-8">
      <div className="w-full max-w-sm sm:max-w-md">
        ...
        <div className="text-center mb-4 sm:mb-6 md:mb-8">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 mb-1 sm:mb-2">RestroManage</h1>
          <p className="text-gray-600 text-xs sm:text-sm md:text-base">Sign in to your restaurant dashboard</p>
        </div>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 md:p-8 border border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div>
              <label htmlFor="restaurantCode" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">
                Restaurant Code
              </label>
              <input
                id="restaurantCode"
                ...
                className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm sm:text-base md:text-lg"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 pr-10 sm:pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm sm:text-base md:text-lg"
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-2 sm:right-3 flex items-center hover:text-blue-500 transition-colors p-1"
                >
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white font-semibold py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg transition-all duration-200 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed flex items-center justify-center text-sm sm:text-base md:text-lg"
            >
              {isLoading ? (
                <>
